...
import timber.log.Timber;
    ...
    public class SocketFactory extends javax.net.ssl.SSLSocketFactory {
        ...
        public SocketFactory(SocketFactoryOptions options) throws KeyStoreException,
                NoSuchAlgorithmException, IOException, KeyManagementException, java.security.cert.CertificateException, UnrecoverableKeyException {
